...
\title{{\Huge Blueprints:}\\Creating, Describing, and Implementing  Designs\\for Larger-scale Software
...
\include{oddsAndEnds}
\include{soundings}
% encapsulation chapter -- state and behavior
% \include{persistence}
\include{heirs}
\include{heirs2}
\include{factory}
\include{teamDev}
\include{useCases}
% use case chapter...before or after "discovering"?
\include{discovering}
