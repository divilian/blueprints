...
% TODO: We need to introduce the term "client code" in this chapter.
% Put Exceptions stuff in separate chapter? In any case, we do need to add
% "how to interpret a stack trace" somewhere, probably here (or in new
% Exceptions chapter.)
