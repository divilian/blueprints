...
\texttt{dependency!dependency association}
...
\index{uses@``uses'' stereotype}
\index{instantiates@``instantiates'' stereotype}
...
The code above \textit{does} compile cleanly for one simple reason: it's a
