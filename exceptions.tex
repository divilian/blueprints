% TODO: explain somewhere that you can have subclasses that inherit from
% Exception, and catch them in different catch blocks. (Seems like it would go
% in this chapter, but we haven't covered inheritance yet, so...)
